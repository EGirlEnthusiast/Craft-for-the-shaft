...
| The modpack | [Link](https://www.mediafire.com/file/poih9q8el5ifj8d/Craft_For_The_Shaft_Modpack-0.9.zip/file) |
...
### Verify that the info in the circles are the same, with substituted accounts, of course - **the bottom version number might not appear until the game is launched once
